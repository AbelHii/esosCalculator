...
<html>
    <head>
        <title>Income Tax Estimator 2015</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div id="container">
            <div id="header">
                ...
                <h2 id="heading">Income Tax Estimator 2015</h2>
            </div>
            ...
            <form id="calc" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <table>
                    <tr>
                        <td>
                            <h3>Estimated Total Income Tax for 2015:</h3>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                                $five = $tFi - $tpFive - $zakat ;
                                echo '<b style="color: #ff0000">&nbsp&nbsp'.round($five,2).'</b>';
                            ?>
                        </td>
                    </tr>
                </table>
